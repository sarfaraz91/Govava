...
public class Men_items implements Serializable {

    private String salePrice,name,largeImage,customerRating,customerRatingImage,categoryNode,stock;
    private String shortDescription,longDescription,offerType,isTwoDayShippingEligible,orderable,standardShipRate;
    ...
    public Men_items(String serviceName,String viewItemURL,String itemId,String largeImage,String salePrice, String name) {
    ...
    public Men_items(String name,String salePrice,String largeImage,String serviceName)
    {
        this.serviceName = serviceName;
        this.name = name;
        this.salePrice = salePrice;
    ...
    public void setAvailableOnline(String availableOnline) {
        this.orderable = availableOnline;
    }
